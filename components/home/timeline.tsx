...
const TimelineContent = ({isDesktop}: IDesktop) => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    <div className="flex flex-col">
      ...
      <h2 className="text-2xl md:max-w-2xl w-full seq mt-2">
        Snapshots from projects, research, and community learning.
      </h2>
    </div>
  );
...
const TimelinePlaceholder = () => (
  <section
    ...
    id={getMenuRef("Timeline")}
  >
    <p className="section-title-sm mb-2">TIMELINE</p>
    <h1 className="section-heading mb-4">Growth Timeline</h1>
    <div className="rounded-3xl border border-gray-700/70 bg-gray-800/40 p-8 text-lg">
      <p className="font-medium text-white">
        Timeline details will be updated shortly.
      </p>
      {/* Add Ayush's timeline details later */}
    </div>
  </section>
);
...
const TimelineSection = ({isDesktop}: IDesktop) => {
  ...
  return <TimelineContent isDesktop={isDesktop} />;
};
