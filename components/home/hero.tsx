...
const HeroSection = React.memo(() => {
  ...
  const renderSocialLinks = (): React.ReactNode =>
    Object.keys(SOCIAL_LINKS).map((platform: keyof typeof SOCIAL_LINKS) => (
      <a
        href={SOCIAL_LINKS[platform]}
        key={platform}
        className={`${HERO_STYLES.SOCIAL_LINK} uppercase tracking-wide text-sm`}
        rel="noreferrer"
        target="_blank"
      >
        {platform}
  ...
  const renderHeroContent = (): React.ReactNode => (
    <div className={HERO_STYLES.CONTENT}>
      <div className="md:mb-4 mb-2">
        ...
        <h1 className="text-3xl seq">I am Ayush Kumar</h1>
      </div>
      <p className="mb-4 text-lg md:text-xl">
        Student Developer who loves full-stack engineering, AI/ML experiments,
